...
rospy.init_node('lr_gym_utils_test_python3', anonymous=True)

moveEeClient = actionlib.SimpleActionClient('/move_helper/move_to_ee_pose', lr_gym_utils.msg.MoveToEePoseAction)
moveJointsClient = actionlib.SimpleActionClient('/move_helper/move_to_joint_pose', lr_gym_utils.msg.MoveToJointPoseAction)

moveEeClient.wait_for_server()
moveJointsClient.wait_for_server()

rospy.wait_for_service("/move_helper/get_ee_pose")
getEePoseService = rospy.ServiceProxy('/move_helper/get_ee_pose', lr_gym_utils.srv.GetEePose)
rospy.wait_for_service("/move_helper/get_joint_state")
getJointStateService = rospy.ServiceProxy('/move_helper/get_joint_state', lr_gym_utils.srv.GetJointState)
