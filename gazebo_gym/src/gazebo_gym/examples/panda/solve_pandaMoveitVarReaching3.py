...
import gazebo_gym
from gazebo_gym.envs.PandaMoveitPoseReachingEnv3 import PandaMoveitPoseReachingEnv
...
def main(fileToLoad : str = None, usePlugin : bool = False):
    ...
    def sampleGoal(rng):
        ...
        p = gazebo_gym.utils.utils.Pose(x=position[0],y=position[1],z=position[2],qx=0.707, qy=0, qz=0.707, qw=0)
        return p


    print("Setting up environment...")
    env = PandaMoveitPoseReachingEnv(   goalPoseSamplFunc=sampleGoal,
