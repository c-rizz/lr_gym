 ...
 * topic of type \c lr_gym_utils/LinkStates. The following is a basic configuration of the controller.
 *
 * \code
...
private:
  ...
  std::shared_ptr<realtime_tools::RealtimePublisher<lr_gym_utils::LinkStates> > realtime_pub_;
