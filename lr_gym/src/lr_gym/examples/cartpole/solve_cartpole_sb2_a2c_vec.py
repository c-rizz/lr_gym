...
def main() -> None:
    ...
    env = stable_baselines.common.vec_env.SubprocVecEnv([constructEnv for i in range(args["envsNum"])])  # 7 is good on an 8-core cpu (tested on i7-6820HK, 4 cores, 8 threads)
