...
namespace gazebo_gym_utils
{
                                  ...
                                  ros::NodeHandle&                         controller_nh)
  {
    ...
    // realtime publisher
    realtime_pub_.reset(new realtime_tools::RealtimePublisher<gazebo_gym_utils::LinkStates>(root_nh, "link_states", 4));
...
PLUGINLIB_EXPORT_CLASS( gazebo_gym_utils::LinkStatePublisherController, controller_interface::ControllerBase)
